...
/**
 * Given an integer, , traverse its digits (1,2,...,n) and determine how many
 * digits evenly divide  (i.e.: count the number of times  divided by each
 * digit i has a remainder of ). Print the number of evenly divisible digits.
 *
    ...
    public static void main(String[] args) {
        ...
        for(int a0 = 0; a0 < t; a0++){
            ...
            for (Character ch : line.toCharArray()) {
                int m = ch - '0';
                //System.out.println("Checking if " + n + " is divisble by " + m);
                if (m != 0 && n % m == 0) {
                    count++;
                }
            }
