...
//2 and 3 respectively. These numbers also denote the width of the vehicle. We
...
//
//Note 
//Calvin has to pass through all segments from index i to indexj (both
//inclusive).
//
//Constraints 
//2 <= N <= 100000 
...
//   6: |       |---|           3
//   7: |       |---|           3
//   (0, 3): Because width[2] = 1, only the bike represented as 1 can pass
//   through it.
//   (4, 6): Here the largest allowed vehicle which can pass through the 5th
//   segment is car and for the 4th and 6th segment it's the truck. Hence the
//   largest vehicle allowed in these segments is a car.
//   (6, 7): In this example, the vehicle enters at the 6th segment and exits
//   at the 7th segment. Both segments allow even truck to pass through them.
//   Hence truck is the answer.
//   (3, 5): width[3] = width[5] = 2. While 4th segment allow the truck, 3rd
//   and 5th allow upto car. So 2 will be the answer here.
//   (0, 7): Bike is the only vehicle which can pass through the 2nd segment,
